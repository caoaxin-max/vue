...
const state = {
  ...
  exam: {
    ...
    question: {
      ...
      editUrlEnum: [{ key: 1, value: 'singleChoicePage', name: '单选题' },
        { key: 2, value: 'multipleChoicePage', name: '多选题' },
        { key: 3, value: 'trueFalsePage', name: '判断题' },
        { key: 4, value: 'gapFillingPage', name: '填空题' },
        { key: 5, value: 'shortAnswerPage', name: '简答题' }],
      answer: {
