    ...
    >
      ...
      <div v-else-if="qType == 4">
        ...
        <div v-if="answer.content !== null">
          ...
          >
            <el-input v-model="answer.content" disabled/>
          </el-form-item>
        </div>
      </div>
      ...
      <div class="question-answer-show-item">
        ...
        <span
          v-if="qType == 1 || qType == 5"
          v-html="question.correct"
          class="q-item-span-content"
        />
        <span
          v-if="qType == 2"
          v-html="question.correctArray"
          class="q-item-span-content"
        />
        <span
          v-if="qType == 3"
          ...
          class="q-item-span-content"
        />
        <span v-if="qType == 4">{{ question.correct }}</span>
      </div>
    </div>
    <div v-else></div>
  </div>
...
export default {
  ...
  props: {
    ...
    answer: {
      type: Object,
      default: function () {
        return { id: null, content: "", contentArray: [], doRight: null };
      },
    },
    qLoading: {
      type: Boolean,
