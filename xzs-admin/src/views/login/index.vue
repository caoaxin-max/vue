<template>
  <div class="login-container">
    ...
    <div class="account-foot-copyright">
      <span>Copyright © 2023 曹阿鑫 版权所有</span>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapMutations("user", ["setUserName", "setToken"]),
      ...
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          ...
          if (this.loginForm.remember) {
            ...
            cookie.set('remember', this.loginForm.remember, { expires: 30 });
          } else {
          ...
          loginApi
            ...
            .then(function (result) {
              if (result && result.code === 200) {
                ...
                _this.setToken(result.data.access_token, result.data.expires_in);
